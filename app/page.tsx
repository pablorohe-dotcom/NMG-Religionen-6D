...
const matchingSets = [
  ...
  { kind: 'pairs', title: 'Gottheiten', subtitle: 'Lies die Beschreibung und wähle rechts den passenden Namen.', pairs: [
    { name: 'Brahma', clue: 'Schöpfer; oft mit vier Köpfen dargestellt' },
    { name: 'Vishnu', clue: 'Bewahrer; seine Avatare sind unter anderem Rama und Krishna' },
    { name: 'Shiva', clue: 'Steht für Verwandlung, Zerstörung und Neubeginn' },
    { name: 'Ganesha', clue: 'Hat einen Elefantenkopf und steht für Neuanfänge' },
    { name: 'Lakshmi', clue: 'Steht für Glück und Wohlstand; ihr Zeichen ist der Lotus' },
    { name: 'Saraswati', clue: 'Steht für Wissen, Musik und Kunst' },
  ] },
] as const;
