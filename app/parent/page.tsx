...
export default function ParentPage() {
  ...
  return <ParentShell>
    ...
    {selectedAppKey === DEFAULT_APP_KEY && <section className="materialsPanel"><div className="materialsHeading"><div><p className="eyebrow">MATERIALIEN FÜR FAMILIEN</p><h2>Lernstoff, Lösungen und Begleitung</h2></div><p>Alle Dokumente sind ohne Zugriff auf die ursprünglichen Fotos verständlich und können heruntergeladen oder ausgedruckt werden.</p></div><div className="materialsGrid">
      <a className="materialCard" href="/materials/Loesungen_Pruefung_1_DE_ES.pdf" download><span className="materialLanguage">DE · ES</span><strong>Lösungen zu Prüfung Teil 1</strong><small>Vollständige, selbstständige Erklärungen</small><b>PDF herunterladen ↓</b></a>
      <a className="materialCard" href="/materials/Material_estudio_y_guia_padres_Prueba_1_ES.pdf" download><span className="materialLanguage">ES</span><strong>Material de estudio y guía para padres</strong><small>Contenido, plan de cinco días y respuestas</small><b>Descargar PDF ↓</b></a>
      <a className="materialCard" href="/materials/Praxisleitfaden_Familie_Pruefung_1_DE.pdf" download><span className="materialLanguage">DE</span><strong>Praxisleitfaden für Familien</strong><small>15-Minuten-Routine und hilfreiche Rückfragen</small><b>PDF herunterladen ↓</b></a>
      <a className="materialCard" href="/materials/Practical_Family_Guide_Test_1_EN.pdf" download><span className="materialLanguage">EN</span><strong>Practical family guide</strong><small>Short routines, feedback and sensitive language</small><b>Download PDF ↓</b></a>
    </div></section>}
