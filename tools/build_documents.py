...
def build_german():
    ...
    h2(doc, "Bibel und Sakramente")
    table(doc, ["Prüfungsbegriff", "Präzise Lernantwort"], [["Bibel", "Erstes/Altes und Neues Testament; 66 Bücher ist die evangelische Zählung."], ["Evangelium", "Frohe Botschaft; Matthäus, Markus, Lukas und Johannes."], ["7 katholische Sakramente", "Taufe, Firmung, Eucharistie, Busse, Krankensalbung, Weihe und Ehe."], ["2 evangelische Sakramente", "Taufe und Abendmahl; Konfirmation ist eine wichtige Feier."]], [1.9, 4.6], 9.0)
    ...
    h2(doc, "Der Koran")
    paragraph(doc, "Der Koran umfasst 114 Suren. Sein arabischer Wortlaut ist zentral; Übersetzungen helfen beim Verstehen. Die vorgeschriebenen Rezitationen des Ritualgebets sind arabisch, persönliche Bittgebete können aber auch in anderen Sprachen gesprochen werden.")
    ...
    table(doc, ["Begriff", "Funktion"], [["Toraschrein", "Aufbewahrungsort für Torarollen; zur Seite Jerusalems ausgerichtet"], ["Bima", "Ort oder Lesepult für die Toralesung"], ["Ewiges Licht", "Licht nahe dem Toraschrein"], ["Mesusa", "Hülse am Türpfosten mit Pergamenttext"], ["Siddur", "Gebetbuch"], ["Kantor", "leitet den liturgischen Gesang"]], [1.35, 5.15], 9.2)
    h2(doc, "Feste und Schrift")
    bullets(doc, ["Rosch Haschana ist das jüdische Neujahrsfest.", "Jom Kippur ist der Versöhnungstag: Umkehr, Vergebung und Versöhnung stehen im Mittelpunkt.", "Hebräisch wird von rechts nach links gelesen; eine Torarolle wird von einem Sofer auf Pergament geschrieben.", "Eine Chanukkia hat acht Festlichter und ein Dienerlicht, also neun Lichter."])
...
def build_spanish():
    ...
    h2(doc, "Biblia y sacramentos")
    table(doc, ["Término", "Respuesta precisa"], [["Bibel", "Primer/Antiguo y Nuevo Testamento; 66 libros es el recuento evangélico."], ["Evangelium", "Buena noticia; Mateo, Marcos, Lucas y Juan."], ["7 sacramentos católicos", "Bautismo, confirmación, eucaristía, penitencia, unción, orden y matrimonio."], ["2 sacramentos evangélicos", "Bautismo y cena del Señor; la confirmación evangélica es una celebración importante."]], [2.0, 4.5], 8.9)
    ...
    h2(doc, "El Corán")
    paragraph(doc, "El Corán tiene 114 suras. El texto árabe ocupa un lugar central y las traducciones ayudan a comprenderlo. Las recitaciones prescritas del rezo ritual son en árabe, pero las súplicas personales pueden expresarse en otras lenguas.")
    ...
    h2(doc, "Sinagoga, escritura y fiestas")
    table(doc, ["Término", "Qué debe saber David"], [["Toraschrein", "Arca para los rollos, orientada hacia Jerusalén."], ["Bima", "Lugar o atril de lectura de la Torá."], ["Ewiges Licht", "Luz eterna junto al arca."], ["Mesusa", "Estuche con pergamino en el marco de la puerta."], ["Rosch Haschana", "Año nuevo judío."], ["Jom Kippur", "Día de expiación, perdón y reconciliación."], ["Chanukkia", "Ocho luces festivas más el shamash: nueve en total."]], [1.75, 4.75], 8.8)
    h2(doc, "Similitudes")
...
def build_solutions_german():
    ...
    page_break(doc)
    h1(doc, "13. Geprüfte Lösungen aus den neuen Blättern")
    h2(doc, "Bibel und Sakramente")
    table(doc, ["Aufgabe", "Geprüfte Lösung"], [["Teile der Bibel", "Erstes/Altes Testament und Neues Testament."], ["Bücherzahl", "66 in der evangelischen Zählung; andere christliche Traditionen zählen anders."], ["Evangelien", "Matthäus, Markus, Lukas und Johannes; Evangelium bedeutet frohe Botschaft."], ["Katholische Sakramente", "Taufe, Firmung, Eucharistie, Busse/Versöhnung, Krankensalbung, Weihe und Ehe."], ["Evangelische Sakramente", "Taufe und Abendmahl; Konfirmation und Trauung sind wichtige Feiern."]], [2.0, 4.5], 8.6)
    h2(doc, "Koran und Judentum")
    table(doc, ["Aufgabe", "Geprüfte Lösung"], [["Koran", "114 Suren; arabischer Wortlaut; Übersetzungen geben Bedeutungen wieder."], ["Überlieferung", "Mündlich und schriftlich bewahrt; nach Mohammeds Tod gesammelt und vereinheitlicht."], ["Hebräisch/Tora", "Von rechts nach links; Torarollen werden von einem Sofer auf Pergament geschrieben."], ["Jüdische Feste", "Rosch Haschana: Neujahr. Jom Kippur: Umkehr, Vergebung und Versöhnung."], ["Synagoge", "Toraschrein, Bima, Ewiges Licht, Mesusa, Siddur und Kantor."], ["Chanukkia", "Neun Lichter: acht Festlichter und das Dienerlicht Schamasch."]], [2.0, 4.5], 8.5)
    paragraph(doc, "Die Angaben 'alle Gebete nur arabisch', 'Chanukka-Leuchter mit acht Armen' und 'Frauen immer auf der Empore' wurden nicht ungeprüft übernommen.", italic=True, color=MUTED, size=9)

    page_break(doc)
    h1(doc, "14. Schnellkontrolle für Eltern")
    qblock(doc, [
...
def build_solutions_spanish():
    ...
    page_break(doc)
    h1(doc, "13. Soluciones verificadas de las fichas nuevas")
    h2(doc, "Biblia y sacramentos")
    table(doc, ["Actividad", "Solución comprobada"], [["Partes de la Biblia", "Primer/Antiguo Testamento y Nuevo Testamento."], ["Número de libros", "66 en el canon evangélico; otras tradiciones cristianas cuentan de otro modo."], ["Evangelios", "Mateo, Marcos, Lucas y Juan; Evangelium significa buena noticia."], ["Sacramentos católicos", "Bautismo, confirmación, eucaristía, penitencia/reconciliación, unción, orden y matrimonio."], ["Sacramentos evangélicos", "Bautismo y cena del Señor; Konfirmation y Trauung son celebraciones importantes."]], [2.0, 4.5], 8.5)
    h2(doc, "Corán y judaísmo")
    table(doc, ["Actividad", "Solución comprobada"], [["Corán", "114 suras; texto árabe; las traducciones reproducen significados."], ["Transmisión", "Conservación oral y escrita; recopilación y unificación después de la muerte de Mahoma."], ["Hebreo y Torá", "Lectura de derecha a izquierda; un sofer escribe la Torá a mano sobre pergamino."], ["Fiestas judías", "Rosch Haschana: año nuevo. Jom Kippur: conversión, perdón y reconciliación."], ["Sinagoga", "Toraschrein, Bima, Ewiges Licht, Mesusa, Siddur y Kantor."], ["Chanukkia", "Nueve luces: ocho festivas y la luz auxiliar shamash."]], [2.0, 4.5], 8.4)
    paragraph(doc, "No se copiaron como hechos universales las frases 'todas las oraciones solo en árabe', 'candelabro de ocho brazos' o 'las mujeres siempre en la galería'.", italic=True, color=MUTED, size=9)

    page_break(doc)
    h1(doc, "14. Control rápido para familias")
...
def build_solutions_english():
    ...
    page_break(doc)
    h1(doc, "13. Verified answers from the new worksheets")
    h2(doc, "Bible and sacraments")
    table(doc, ["Task", "Checked answer"], [["Bible sections", "First/Old Testament and New Testament."], ["Number of books", "66 in the Protestant canon; other Christian traditions count differently."], ["Gospels", "Matthew, Mark, Luke and John; Evangelium means good news."], ["Catholic sacraments", "Baptism, Confirmation, Eucharist, Penance/Reconciliation, Anointing, Holy Orders and Matrimony."], ["Protestant sacraments", "Baptism and the Lord's Supper; confirmation and marriage are important services."]], [2.0, 4.5], 8.5)
    h2(doc, "Quran and Judaism")
    table(doc, ["Task", "Checked answer"], [["Quran", "114 surahs; Arabic text; translations convey meanings."], ["Transmission", "Preserved orally and in writing; collected and standardised after Mohammed's death."], ["Hebrew and Torah", "Read right to left; a sofer writes a Torah scroll by hand on parchment."], ["Jewish festivals", "Rosh Hashanah: New Year. Yom Kippur: repentance, forgiveness and reconciliation."], ["Synagogue", "Torah ark, bimah, eternal light, mezuzah, siddur and cantor."], ["Hanukkiah", "Nine lights: eight festival lights plus the helper light, shamash."]], [2.0, 4.5], 8.4)
    paragraph(doc, "The claims 'all prayers only in Arabic', 'an eight-branched Hanukkah lamp' and 'women always sit in a gallery' were not copied as universal facts.", italic=True, color=MUTED, size=9)

    page_break(doc)
    h1(doc, "14. Quick family check")
